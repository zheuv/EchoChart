...
function fetchit(category) {
    ...
    fetch(`/currency-pairs/`)
        ...
        .then(data => {
		    ...
		    launchButton.innerHTML = '<text>Launch Chart</text>';
		    ...
		    backtestButton.innerHTML = "<text>Backtest Chart</text>"
		    backtestButton.addEventListener('click', () => {
                        window.location.href = `/backtest-chart/${pair.symbol}`; // Update with your URL pattern
                    });
